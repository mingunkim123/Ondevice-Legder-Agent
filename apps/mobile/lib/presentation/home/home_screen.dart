      ...
      body: CustomScrollView(
        slivers: [
              ...
              data: (data) {
                ...
                return Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        const Text('이번 달 총 지출', style: TextStyle(fontSize: 16)),
          ...
          transactionsAsync.when(
            ...
            error: (e, st) =>
                SliverToBoxAdapter(child: Center(child: Text('목록 통신 오류: $e'))),
            data: (list) {
              if (list.isEmpty) {
                return const SliverToBoxAdapter(
                  child: Padding(
                    padding: EdgeInsets.all(32.0),
                    child: Center(child: Text('이번 달은 아직 지출 내역이 발견되지 않았습니다 🌱')),
                  ),
                );
              }
              return SliverList(
